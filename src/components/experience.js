      ...
      <>
        <div id="experience" className="background h-fit pb-10 ">
          ...
          <div className=" ml-5 sm:ml-40 mt-5">
            ...
            <p className=" text-white  w-56 sm:w-96 ml-3 sm:ml-48 mt-2 sm:mt-8 opacity-80 text-sm sm:text-xl">
          ...
          <div className=" ml-5 sm:ml-40 mt-5">
            ...
            <p className=" text-white  w-64 md:w-96 ml-3 sm:ml-48 mt-2 sm:mt-8 opacity-80 text-sm sm:text-xl">
